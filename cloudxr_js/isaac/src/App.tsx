...
const store = createXRStore({
  ...
  foveation: kPerformanceOptions.xrWebGLLayer_fixedFoveationLevel,

  frameBufferScaling: kPerformanceOptions.xrWebGLLayer_framebufferScaleFactor,
    ...
    <>
      <Canvas
        ...
        gl={{
          ...
          powerPreference: 'high-performance', // R3F default, but being explicit
